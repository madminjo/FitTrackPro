			...
			>
					...
					{loading ? (
						...
						workouts.map(workout => (
							<TouchableOpacity
								...
								onPress={() =>
									Alert.alert(workout.title, 'Открыть детали тренировки')
								}
							>
								<View style={tw`flex-row`}>
									{workout.images ? (
										...
										<View
											style={tw`w-20 h-20 rounded-lg mr-4 bg-gray-200 items-center justify-center`}
										>
									...
									<View style={tw`flex-1`}>
										<View style={tw`flex-row justify-between items-start`}>
											<Text
												style={tw`text-lg font-bold text-gray-800 flex-1 mr-2`}
											>
												{workout.title}
											</Text>
				...
				{totalPages > 1 && (
					<View style={tw`flex-row justify-between items-center mb-8`}>
						...
						>
							<Text
								style={tw`${page === 1 ? 'text-gray-400' : 'text-purple-800'}`}
							>
								Назад
							</Text>
						</TouchableOpacity>
						...
						>
							<Text
								style={tw`${page === totalPages ? 'text-gray-400' : 'text-purple-800'}`}
							>
								Вперед
							</Text>
						</TouchableOpacity>
