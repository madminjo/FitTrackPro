			...
			>
				<View style={tw`items-center mb-6`}>
					<View style={tw`relative`}>
						...
						/>
						<View
							style={tw`absolute bottom-0 right-0 bg-[#6200ee] rounded-full p-1`}
						>
				...
				<View style={tw`bg-white rounded-2xl p-4 border border-gray-200 mb-6`}>
					<View style={tw`flex-row justify-between items-center mb-4`}>
						<Text
							style={tw`text-xl font-semibold text-zinc-900 text-[#6200ee]`}
						>
							Personal Data
						</Text>
					...
					<InfoRow
						icon='phone'
						label='Phone'
						value={formatValue(user?.phone_number)}
					/>
					<Divider />
					<InfoRow
						icon='account'
					...
					<InfoRow
						...
						value={formatActivity(user?.physical_activity)}
					/>
				</View>
